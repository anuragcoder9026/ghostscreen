    ...
    return (
        <section id="home" className="pt-32 pb-20 text-center overflow-hidden">
            <div className="container mx-auto px-4 sm:px-6 mb-12">
                <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-4 tracking-tighter text-gray-900 dark:text-white">Stay Private and Invisible with <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">Oview</span></h1>
